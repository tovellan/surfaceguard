...
The Tovellan organization appoints maintainers. Maintainers review changes, manage releases, handle security reports, and preserve the project's scope and security properties. Current maintainers are represented by repository permissions rather than a named list.

## Decisions

Routine decisions use reviewed pull requests. Material changes to policy semantics, trust boundaries, report compatibility, licensing, or governance require a repository design issue and documented maintainer consensus.
